...
public class InteractableTache : MonoBehaviour, IInteractable
{
    ...
    [SerializeField] int IDTacheSupprime;

    [SerializeField] string TexteTacheAjout;
    [SerializeField] int IDTacheAjout;
    ...
    public void Interact() {
        TaskManager.StopTask(IDTacheSupprime);
    }
}
